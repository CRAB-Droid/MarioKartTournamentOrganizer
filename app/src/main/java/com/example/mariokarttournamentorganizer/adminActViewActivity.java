...
public class adminActViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enterResultsButton = findViewById(R.id.joinOrResultsButton);
...
//        test2 = findViewById(R.id.testTextView2);
        ...
        whoTextView.setText("Name of ACT: " + getIntent().getStringExtra("name"));
        ...
        whenTextView.setText(stringBuilder.toString());
    }
